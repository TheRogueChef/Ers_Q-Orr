        ...
        <div className='AMShell'  >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-evenly'}}>
                <div className='AMLeft'>
                 <p>I am Ers Q"Orr</p>   
                 <p> I was born in Ronion, Mandalore in 32 BBY, well before the proclamation of Mandalores neutrality. However,soon afterwards my parents saw life in the bio~dome was not sustainable. My family took up residence on the moon of Concordia soon after the living conditions became so dire in Ronion. The time on Concordia was short lived due to influence from The Watch and soon afterwards my family moved to Celanon.</p>
