        ...
        <div className='AMShell'  >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-evenly'}}>
                <div className='AMLeft'>
                 <p>I am Ers Q"Orr</p>   
                 <p> I was born in Ronion, Mandalore 32 BBY, before the Duchess' proclamation of Mandalores neutrality. My family took up residence on the moon of Concordia soon after the living conditions became so dire on Mandalore. The time on Concordia was short lived due to the Watch influence and soon afterwards my family moved to Celanon.</p>
